    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-gray-600 ${showFilters ? 'flex' : 'hidden sm:flex' }`}>
          ...
          <p onClick={()=>{specialty === 'Gynaecologist' ? navigate('/doctors') : navigate('/doctors/Gynaecologist') }} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${specialty === "Gynecologist" ? "bg-indigo-100 text-black" : ""}`}>Gynecologist</p>
          ...
          <p onClick={()=>{specialty === 'Paediatrician' ? navigate('/doctors') : navigate('/doctors/Paediatrician')}} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${specialty === "Pediatricians" ? "bg-indigo-100 text-black" : ""}`}>Pediatricians</p>
